...
<x-dashboard.header>
    ...
    <div class="text-xl font-bold">{{ __('dashboard.edit_external_page') }} ({{ $page['title'] }})</div>
</x-dashboard.header>
...
<div class="grid sm:grid-cols-1 md:grid-cols-2 gap-2">
    ...
    <div class="col-span-1 bg-white rounded-lg shadow p-6 h-full">
        ...
        <form action="{{ route('dashboard.external_pages.update', $page->id) }}" method="post" enctype="multipart/form-data">
            @method('PUT')
            @csrf
