...
<div
    ...
    <i class="text-[#c0942c] text-[20px] relative fa-solid fa-bars cursor-pointer"></i>
        <ul style="backdrop-filter: brightness(0.7) blur(10px);"
            ...
            text-center flex gap-y-[10px] flex-wrap p-[15px] gap-0 w-[250px] justify-center  items-center font-semibold rounded-[24px] ">
