    ...
    <div id="menu" class="active hidden lg:flex fixed z-[999999] ">
        ...
        <div class="content-menu lg:px-[30px]">
            <ul class="px-[10px] lg:gap-[50px] gap-[24px] flex justify-center items-center cursor-pointer">
                ...
                <li class="font-bold text-[13px] leading-[18.2px] text-[#FFFFFF]"><a role="button" onclick="goToSection('about')"><span>
                        من نحن
                </span></a></li>
                <li class="font-bold text-[13px] leading-[18.2px] text-[#FFFFFF]"><a role="button" onclick="goToSection('products')"><span>منتجاتنا</span></a></li>
                <li class="font-bold text-[13px] leading-[18.2px] text-[#FFFFFF]"><a role="button" onclick="goToSection('projects')"><span>مشاريعنا</span></a></li>
                <li class="font-bold text-[13px] leading-[18.2px] text-[#FFFFFF]"><a role="button" onclick="goToSection('blogs')"><span>المدونة</span></a></li>
            </ul>
        </div>
