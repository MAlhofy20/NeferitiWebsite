...
@section('content')
    ...
    <div class="the-pahe bg-white relative md:pt-[50px] overflow-hidden">
        ...
        <div id="blogs" class="blogs p-[20px] ">
            <div
                class="title gap-[10px] flex justify-center flex-wrap md:flex-nowrap md:justify-between pb-[50px] text-center md:pr-[50px] items-center">
                <div class="ti text-[34px] md:text-[42px] md:font-[800] font-bold">أحدث منشورات مدونتنا</div>
            </div>
